...
export class TranstringsferEvent extends ethereum.Event {
  get params(): TranstringsferEvent__Params {
    return new TranstringsferEvent__Params(this);
  }
}

export class TranstringsferEvent__Params {
  _event: TranstringsferEvent;

  constructor(event: TranstringsferEvent) {
    this._event = event;
  }
